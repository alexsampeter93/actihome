...
public class PublishReviewFrame extends JFrame {
	...
	public PublishReviewFrame(ReviewService reviewService, ApplicationContext context, SessionManager sessionManager) {
	...
	private void initUi() {
		...
		jpanel.setBorder(BorderFactory.createTitledBorder("Publicar crítica"));
	...
	private void publish() {
		...
		try {
			reviewService.publishReview(sessionManager.getLoggedInUser().getId(), housingId, titleField.getText(),
